    ...
    <div className="space-y-6">
      ...
      <div className="grid gap-6 lg:grid-cols-2">
        ...
        <p className="mb-4 mt-1 text-xs text-slate-500 dark:text-slate-400">
          ...
          <span className="font-mono text-indigo-600 dark:text-indigo-400">name</span>
          {", "}
          <span className="font-mono text-indigo-600 dark:text-indigo-400">email</span>
          {", "}
          <span className="font-mono text-indigo-600 dark:text-indigo-400">industry</span>
          {", "}
          <span className="font-mono text-indigo-600 dark:text-indigo-400">notes</span>
        </p>
...
ABC Inc., contact@abc.com, Technology, Interested in partnerships`}
            rows={6}
            className="mb-3 w-full rounded-lg border border-slate-200 bg-white px-3 py-2 text-sm placeholder:text-slate-400 dark:border-white/10 dark:bg-white/10 dark:placeholder:text-slate-500"
          />
          <button
            onClick={handleParse}
        ...
        <div className="mt-5 grid gap-3">
          ...
          <div>
            ...
            <p className="mb-2 text-xs text-slate-500 dark:text-slate-400">
              Use placeholders:{" "}
              <span className="font-mono text-indigo-600 dark:text-indigo-400">[[Company Name]]</span>
              {", "}
              <span className="font-mono text-indigo-600 dark:text-indigo-400">[[Company Industry]]</span>
              {", "}
              <span className="font-mono text-indigo-600 dark:text-indigo-400">[[Company Email]]</span>
              {", "}
              <span className="font-mono text-indigo-600 dark:text-indigo-400">[[Notes]]</span>
            </p>
            <input
                ...
                <tr key={idx} className="bg-white/70 dark:bg-white/5">
                  ...
                  <td className="p-3">
                    <div className="max-w-md">
                      <div className="text-sm break-words">{displayMessage}</div>
